...
Creates and populates the "Because You Watched" rows on a user's profile. This algorithm takes a movie or show that was watched by a user, and searches for similiar content. It then calculates the similarity of that content, and populates the row with the most similiar items. Out if the five algorithms, this is the least personalized algorithm.
