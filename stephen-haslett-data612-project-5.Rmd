...
Additionally, the RMSE for the distributed model is much better than that of the non-distributed model. This again suggests that the distributed model is the better choice when it comes to prediction errors.
