...
a comparatively small amount of jokes in the set earned the highest rating of 10.
...
As reflected in the above table, The least accurate model is the RANDOM model, were as the most accurate model is the UBCF model. This is not surprising
