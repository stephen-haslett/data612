...
metadata_refined <- select(amazon_magazine_metadata, asin, brand, title)
...
split_data <- ratings %>% sdf_random_split(training = 0.9, testing = 0.2)
```
