...
## Data Analysis
With the alterations to our dataset complete, we are now in a position to do a brief analysis of our data.

### Distribution of ratings
As we can see from the below bar plot, the majority of magazine subscriptions were given high ratings.    
...
magazine_ratings %>% 
  ggplot(aes(rating)) +
  geom_bar() +
  labs(title = "Distribution of Ratings", y = "", x = "Ratings") +
  theme_minimal()
```
...
magazine_ratings %>% 
  ...
  labs(title = "Distribution of Ratings per Subscription", y = "", x = "") +
  theme_minimal()
```
